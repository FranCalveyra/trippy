    ...
    "flex items-start px-4 py-3",
    {
        variants: {
            variant: {
                ...
                warning: "w-[319px] h-[134px] pb-2.5 justify-end items-center inline-flex",
            },
        },
        defaultVariants: {
            variant: "default",
    ...
    return (
        <div className={notificationVariant({ variant })}>
            <div className={`flex ${variant === "warning" ? "px-3 py-6 bg-white rounded-[13px] justify-start items-start gap-2 inline-flex" 
                ...
                <div className={`${variant === "warning" ? "w-[38.77px] h-[41.23px] relative bg-status-warning/50 rounded-full flex items-center justify-center" 
                ...
                <div className="flex flex-col">
                    ...
                    <div className={`${variant === "warning" ? "w-[202px] text-primary-700 text-base font-normal leading-normal tracking-tight truncate overflow-hidden whitespace-nowrap text-ellipsis" 
